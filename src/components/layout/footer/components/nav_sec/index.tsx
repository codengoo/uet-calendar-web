...
export default function NavSec({ links, title }: INavSecProps) {
    return (
        <div className="col-span-4 flex flex-col items-center md:items-end">
            <h1 className="flex flex-col items-center md:items-end text-white text-xl mb-4 uppercase after:h-1 after:w-4/6 after:bg-white w-fit">
                {title}
            </h1>
